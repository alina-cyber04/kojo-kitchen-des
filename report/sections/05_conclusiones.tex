...
$t = 10{,}8$, IC de la diferencia $[11{,}03;\;16{,}18]$\,\%) de que incorporar
...
($\lambda_{\text{peak}} = 0{,}30$ clientes/min).
...
\begin{itemize}
  ...
  \item El análisis de sensibilidad revela que la ventaja del Escenario B
    se mantiene para $\lambda_{\text{peak}} \lesssim 0{,}42$; por encima de
...
\begin{itemize}
  ...
  \item Optimizar el número óptimo de empleados extra como función de
    $\lambda_{\text{peak}}$, generalizando el análisis de sensibilidad.
