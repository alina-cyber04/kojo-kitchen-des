...
del día: $W_q^{\text{día}} = \frac{240}{660}\,W_q^{\text{peak}} + \frac{420}{660}\,W_q^{\text{off-peak}}$,
...
\begin{table}[H]
  ...
  \begin{tabular}{llccc}
    ...
    \textbf{Escenario} & \textbf{Indicador}
      ...
      & \textbf{Sim $-$ Teo (\%)} \\
    \midrule
    A ($c_{\text{peak}}=2$) & $W_q$ (min)      & 3{,}95 & 2{,}19 & $-$44{,}6 \\
    A ($c_{\text{peak}}=2$) & $L_q$ (clientes) & 0{,}86 & 0{,}48 & $-$44{,}2 \\
    B ($c_{\text{peak}}=3$) & $W_q$ (min)      & 1{,}18 & 0{,}66 & $-$44{,}1 \\
    B ($c_{\text{peak}}=3$) & $L_q$ (clientes) & 0{,}26 & 0{,}15 & $-$42{,}3 \\
    \bottomrule
  \end{tabular}
\end{table}
