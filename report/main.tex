...
% ── Portada ───────────────────────────────────────────────────────────────────
% Evita el warning "duplicate destination page.1" de hyperref al combinar
% pagenumbering roman (TOC) y arabic (contenido) en el mismo documento.
...
\begin{titlepage}
  ...
  \vspace{0.4cm}
  {\normalsize Problema No.\ 1: La Cocina de Kojo (Kojo's Kitchen)\par}
  \vspace{1cm}
  {\normalsize Facultad de Matemática y Computación\\
   Universidad de La Habana\par}
  \vspace{1cm}
  {\normalsize Alumna: Alina María de la Noval Armenteros\par}
  \vspace{0.3cm}
  {\normalsize Grupo: C-311\par}
  \vspace{0.3cm}
  {\normalsize \url{https://github.com/alina-cyber04/kojo-kitchen-des}\par}
  \vspace{0.7cm}
  {\normalsize 8 de mayo de 2026\par}
  \vfill
\end{titlepage}
...
\newpage
\input{sections/02_implementacion}
\newpage
\input{sections/03_resultados}
\newpage
\input{sections/04_modelo_matematico}
\newpage
